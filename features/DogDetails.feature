    ...
    Scenario: FT2-1161	Dog Details - Pedigree - As a user I want to see the dog's pedigree.
        ...
        @test
    Scenario: FT2-1162	Dog Details - History - "As an authenticated user I want to see the dog's history.Some users should also be able to see the dog's location history.Sections include: owner history, trainer history, location history, vet endorsements, retirement"
        Given A participant "William Mcmahon" logged in to FastTrack application
