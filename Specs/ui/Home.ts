...
LoginContinue: element(by.css('div.button-bar')),
...
GotIt: element(by.cssContainingText('button.cancel-button.shepherd-button.shepherd-button-secondary', 'Done? Click here to skip'))
