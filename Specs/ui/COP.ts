...
export const COP = {
    ...
    SelectInjuryDate: element(by.xpath("//td[@class='mat-calendar-body-cell mat-calendar-body-active ng-star-inserted']")),
    ...
    SelectTreatmentDate: element(by.xpath("//td[@class='mat-calendar-body-cell mat-calendar-body-active ng-star-inserted']")),
